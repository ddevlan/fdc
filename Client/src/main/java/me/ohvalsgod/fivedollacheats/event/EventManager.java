...
public class EventManager {
    ...
    public void unregister(final Object o) {
        ...
        for (final ArrayHelper<Data> flexibalArray : REGISTRY_MAP.values()) {
    ...
    public void cleanMap(final boolean b) {
        ...
        final Iterator<Map.Entry<Class<? extends Event>, ArrayHelper<Data>>> iterator = REGISTRY_MAP.entrySet().iterator();
